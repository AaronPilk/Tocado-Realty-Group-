    ...
    <>
      ...
      <Section className="bg-cream">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {steps.map((s, i) => (
            <div key={s.t} className="reveal rounded-2xl border border-black/5 shadow-float bg-white p-6">
      ...
      <Section className="bg-white">
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="reveal rounded-2xl border border-black/5 shadow-float bg-cream p-8">
