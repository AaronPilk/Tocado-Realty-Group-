    ...
    <>
      ...
      <Section className="bg-ivory">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-10 divide-y divide-line reveal rounded-2xl border border-black/5 shadow-float bg-white">
            {coreValues.map((v) => (
      ...
      <Section className="bg-white">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            {traits.map((t) => (
              <span key={t} className="reveal rounded-2xl border border-black/5 shadow-float px-5 py-2.5 text-[12px] font-semibold uppercase tracking-[0.14em]">
                {t}
              </span>
            ))}
          </div>
